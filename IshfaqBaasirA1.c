...
/************************IshfaqBaasirA1.c**************
Student Name: Baasir Ishfaq Email Id: bishfaq@uoguelph.ca Due Date: October 4th Course Name: CIS 1300 I have exclusive control over this submission via my password. By including this statement in this header comment, I certify that:
...
gcc IshfaqBaasirA1.c -std=c99 -Wall -o IshfaqBaasirA1
